...
class TorobSpider(scrapy.Spider):
    ...
    myBaseUrl = ''
    start_urls = [
        'https://api.torob.com/v4/base-product/search/?page=1&sort=popularity&size=100&category=94&category_name=%DA%AF%D9%88%D8%B4%DB%8C-%D9%85%D9%88%D8%A8%D8%A7%DB%8C%D9%84-mobile&source=next_desktop&rank_offset=24&_bt__experiment=&suid=66606f82d64bebbac440c734&_url_referrer=',
        'https://api.torob.com/v4/base-product/search/?page=1&sort=popularity&size=100&category=95&category_name=%D8%AA%D8%A8%D9%84%D8%AA-tablet&source=next_desktop&rank_offset=24&_bt__experiment=&suid=6660720269ecceb34e8c9f65&_url_referrer=',
