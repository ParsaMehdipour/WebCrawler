...
# Torob spider
class TorobSpider_MemoryCard(scrapy.Spider):
    name = "TorobSpider_MemoryCard"
    ...
    myBaseUrl = ''
    start_urls = [
        'https://api.torob.com/v4/base-product/search/?page=1&sort=popularity&size=24&category=252&category_name=%DA%A9%D8%A7%D8%B1%D8%AA-%D8%AD%D8%A7%D9%81%D8%B8%D9%87-%D9%88-%D8%B1%D9%85-memory-card&source=next_desktop&rank_offset=24&_bt__experiment=&suid=666861369e59591089d96920&_url_referrer='
    ]
