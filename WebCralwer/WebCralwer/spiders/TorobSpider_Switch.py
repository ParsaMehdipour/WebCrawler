...
# Torob spider
class TorobSpider_Switch(scrapy.Spider):
    name = "TorobSpider_Switch"
    ...
    myBaseUrl = ''
    start_urls = [
        'https://api.torob.com/v4/base-product/search/?page=1&sort=popularity&size=24&category=256&category_name=%D8%B3%D9%88%DB%8C%DB%8C%DA%86-%D9%88-%D8%A7%D8%B3%D9%BE%D9%84%DB%8C%D8%AA%D8%B1-switch&source=next_desktop&rank_offset=24&_bt__experiment=&suid=6668534318c00b314b89bda7&_url_referrer='
    ]
