...
# Torob spider
class TorobSpider_SSDHardDrive(scrapy.Spider):
    name = "TorobSpider_SSDHardDrive"
    ...
    myBaseUrl = ''
    start_urls = [
        'https://api.torob.com/v4/base-product/search/?page=1&sort=popularity&size=24&category=1016&category_name=%D8%AD%D8%A7%D9%81%D8%B8%D9%87-ssd&source=next_desktop&rank_offset=24&_bt__experiment=&suid=666834a4c5ca482f8411cbad&_url_referrer='
    ]
