...
# Torob spider
class TorobSpider_Server(scrapy.Spider):
    name = "TorobSpider_Server"
    ...
    myBaseUrl = ''
    start_urls = [
        'https://api.torob.com/v4/base-product/search/?page=1&sort=popularity&size=24&category=1044&category_name=%D8%B3%D8%B1%D9%88%D8%B1&source=next_desktop&rank_offset=24&_bt__experiment=&suid=66685512eae44e0c846c74df&_url_referrer='
    ]
