...
# Torob spider
class TorobSpider_Router(scrapy.Spider):
    name = "TorobSpider_Router"
    ...
    myBaseUrl = ''
    start_urls = [
        'https://api.torob.com/v4/base-product/search/?page=1&sort=popularity&size=24&category=1248&category_name=%D8%B1%D9%88%D8%AA%D8%B1&source=next_desktop&rank_offset=24&_bt__experiment=&suid=666851118fa1e20bec9f8d04&_url_referrer='
    ]
