...
# Torob spider
class TorobSpider_NetworkMemoryAndStorage(scrapy.Spider):
    name = "TorobSpider_NetworkMemoryAndStorage"
    ...
    myBaseUrl = ''
    start_urls = [
        'https://api.torob.com/v4/base-product/search/?page=1&sort=popularity&size=24&category=258&category_name=%D8%AD%D8%A7%D9%81%D8%B8%D9%87-%D9%88-%D8%B0%D8%AE%DB%8C%D8%B1%D9%87-%D8%B3%D8%A7%D8%B2-%D8%AA%D8%AD%D8%AA-%D8%B4%D8%A8%DA%A9%D9%87-network-memory-and-storage&source=next_desktop&rank_offset=24&_bt__experiment=&suid=6668545b59161f5da2833c51&_url_referrer='
    ]
