...
# Torob spider
class TorobSpider_ExternalHardDrive(scrapy.Spider):
    name = "TorobSpider_ExternalHardDrive"
    ...
    myBaseUrl = ''
    start_urls = [
        'https://api.torob.com/v4/base-product/search/?page=1&sort=popularity&size=24&category=2466&category_name=%D9%87%D8%A7%D8%B1%D8%AF&source=next_desktop&rank_offset=24&_bt__experiment=&suid=66685592171f16860cd23aa0&_url_referrer='
    ]
