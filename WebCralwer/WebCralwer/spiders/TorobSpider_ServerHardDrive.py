...
# Torob spider
class TorobSpider_ServerHardDrive(scrapy.Spider):
    name = "TorobSpider_ServerHardDrive"
    ...
    myBaseUrl = ''
    start_urls = [
        'https://api.torob.com/v4/base-product/search/?page=1&sort=popularity&size=24&category=1800&category_name=%D9%87%D8%A7%D8%B1%D8%AF-%D8%B3%D8%B1%D9%88%D8%B1&source=next_desktop&rank_offset=24&_bt__experiment=&suid=66685fb11ebf2df0a3a783dd&_url_referrer='
    ]
