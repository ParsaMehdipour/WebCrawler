...
# Torob spider
class TorobSpider_FlashMemory(scrapy.Spider):
    name = "TorobSpider_FlashMemory"
    ...
    myBaseUrl = ''
    start_urls = [
        'https://api.torob.com/v4/base-product/search/?page=1&sort=popularity&size=24&category=250&category_name=%D9%81%D9%84%D8%B4-%D9%85%D9%85%D9%88%D8%B1%DB%8C-flash-memory&source=next_desktop&rank_offset=24&_bt__experiment=&suid=66680b926eda0f467b2f4589&_url_referrer='
    ]
