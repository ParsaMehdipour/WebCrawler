...
# Torob spider
class TorobSpider_InternalHardDrive(scrapy.Spider):
    name = "TorobSpider_InternalHardDrive"
    ...
    myBaseUrl = ''
    start_urls = [
        'https://api.torob.com/v4/base-product/search/?page=1&sort=popularity&size=24&category=1015&category_name=%D9%87%D8%A7%D8%B1%D8%AF-%D8%AF%DB%8C%D8%B3%DA%A9-%D8%A7%DB%8C%D9%86%D8%AA%D8%B1%D9%86%D8%A7%D9%84&source=next_desktop&rank_offset=24&_bt__experiment=&suid=6668564bf08a0d38ae3f3dab&_url_referrer='
    ]
